/**
 * AI Config - Shared Constants (Canonical Source)
 *
 * This file owns the definitions for RAG-related constants.
 * Modules under `ragService` re-export from here to keep old imports working.
 */
