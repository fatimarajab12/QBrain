...
function transformProject(backendProject: any): Project {
  ...
  // Handle userId - can be ObjectId string or populated user object
  let userId: string | undefined;
  let user: Project['user'] | undefined;

  if (backendProject.userId) {
    if (typeof backendProject.userId === 'object' && backendProject.userId !== null) {
      // Populated user object
      userId = backendProject.userId._id ? String(backendProject.userId._id) : String(backendProject.userId.id || '');
      user = {
        _id: backendProject.userId._id ? String(backendProject.userId._id) : String(backendProject.userId.id || ''),
        name: backendProject.userId.name,
        email: backendProject.userId.email,
      };
    } else {
      // Just ObjectId string
      userId = String(backendProject.userId);
    }
  }
